...
contains
  ...
  subroutine tracer_index_constructor(this, base_bio_on, abio_dic_on, ciso_on, lvariable_PtoC, &
    ...
    if (base_bio_on) then
      ...
      call this%add_tracer_index('conserved_tracer', 'base_bio', this%conserved_tracer_ind, marbl_status_log)
      call this%add_tracer_index('deficit_tracer', 'base_bio', this%deficit_tracer_ind, marbl_status_log)
