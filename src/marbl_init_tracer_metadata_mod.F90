module marbl_init_tracer_metadata_mod
  ...
  subroutine marbl_init_tracer_metadata(unit_system, marbl_tracer_indices, marbl_tracer_metadata)
    ...
    if (base_bio_on) then
      ...
      call init_non_autotroph_tracer_metadata('C_CONSERVED', 'Conserved tracer',      &
                'base_bio', unit_system, marbl_tracer_metadata(marbl_tracer_indices%conserved_tracer_ind))
      call init_non_autotroph_tracer_metadata('C_DEFICIT', 'Deficit tracer',          &
                'base_bio', unit_system, marbl_tracer_metadata(marbl_tracer_indices%deficit_tracer_ind))
